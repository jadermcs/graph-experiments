...
do
    ...
    # Get normalized (-n) frequencies for both corpora
    python src/shing.py data/$language/corpus1/lemma data/$language/targets.txt data/results/$language/shing1
    python src/shing.py data/$language/corpus2/lemma data/$language/targets.txt data/results/$language/shing2

    # Subtract frequencies and store absolute (-a) difference
    python src/comp.py data/results/$language/shing1 data/results/$language/shing2 data/results/$language/sh_classes.csv data/results/$language/comp.csv

    # Classify results into two classes according to threshold
    python src/class.py data/results/$language/comp.csv data/results/$language/sh_classes.csv 0.4
