...
do
    ...
    python src/freq.py -n data/$language/corpus1/token data/$language/targets.txt data/results/$language/freq_corpus1.csv
    python src/freq.py -n data/$language/corpus2/token data/$language/targets.txt data/results/$language/freq_corpus2.csv
    ...
    python src/cnt.py data/$language/corpus1/token data/matrices/$language/cnt_matrix1 1
    python src/cnt.py data/$language/corpus2/token data/matrices/$language/cnt_matrix2 1
    ...
    # Get normalized (-n) frequencies for both corpora
    python src/shing.py -n data/$language/corpus1/token data/$language/targets.txt data/results/$language/shingles_corpus1.csv
    python src/shing.py -n data/$language/corpus2/token data/$language/targets.txt data/results/$language/shingles_corpus2.csv
