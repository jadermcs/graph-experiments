...
do
    ...
    # Subtract frequencies and store absolute (-a) difference
    python src/comp.py data/results/$language/shing1 data/results/$language/shing2 data/results/$language/comp.csv

    # Classify results into two classes according to threshold
    python src/class.py data/results/$language/comp.csv data/results/$language/sh_classes.csv 0.095
